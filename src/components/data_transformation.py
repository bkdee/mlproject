...
class DataTransformation:
    ...
    def get_data_transformation_obj(self):
        try:
            ...
            logging.info("Numerical & categorical columns transformation completed")

            preprocessor = ColumnTransformer(
                [
                    ("num_pipleine",num_pipeline,numerical_features),
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            pre_processing_object= self.get_data_transformation_obj()
